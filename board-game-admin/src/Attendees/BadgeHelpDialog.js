...
const BadgeHelpDialog = ({ saving, isOpen, toggleDialog, selectedAttendee }) => {
  return (
    ...
    Step 3: Search the badge number in the search box to the left.<br/>
    - If the badge is under a different name than on the receipt, it has already been transferred with their approval.<br/>
    - If the badge is not found, we have no record of their purchase.<br/><br/>
    Step 4: Speak with staff to address the issue.
    </SaveDialog>
  );
};
